        		...
        		<div id="commentdiary">
	    			<div class="comment_column">
						<div class="cmt_con">
			                ...
			                <div>
					            <span><img src="<%=ctxPath%>/resources/images/profile/${reviewLeft.user.profileimg}"></span>
						...
						<div class="comment_column">
						    <div class="cmt_con cmt_R">
						        ...
						        <div>
							        <span><img src="<%=ctxPath%>/resources/images/profile/${reviewRight.user.profileimg}"></span>
