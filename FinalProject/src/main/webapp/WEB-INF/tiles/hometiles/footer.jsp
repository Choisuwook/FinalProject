...
<div style="width:100%;border-top:1px solid lightgray;">
<div class="container" style="margin-top: 10%; margin-right: 18%; width: 63%;margin-top:2%;" >
	<div class=" col-md-12 footer_menues" >	
		...
		<div class="col-md-3">
			...
			<span>Airbnb Citizen</span><br>
			<span>비즈니스 프로그램</span><br>
			<span>가이드북</span><br>
			<span>Airbnbmag</span><br>
		...
		<div class="col-md-3">
			...
			<span>호스팅 기준</span><br>
			<span>책임감 있는 호스트 되기</span><br>
			<span>커뮤니티 센터</span><br>
